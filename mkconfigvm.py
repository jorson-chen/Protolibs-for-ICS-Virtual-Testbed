...
config['simiface']={
    ...
    'recipients' : [('192.168.73.128',9913)], #list of vdevs to send updates to
    'timeout' : .1 
}
config['sim_state']={
        ...
        'points' : [
            {'name':'pump',  'typ':2, 'value':False, 
                    ...
                    'metadata':{'modbus':{ 'addr':'11', 'blockname':'coil',
                                    'blocktype':1},
                                'dnp3': {} }
            }, {'name':'pressure','typ':1, 'value':17, 
                    'metadata':{'modbus':{ 'addr':'30002', 'blockname':'inputreg',
                                    'blocktype':4},
                                'dnp3': {} }
            }, {'name':'setpoint',  'typ':0, 'value':15, 
                    'metadata':{'modbus':{ 'addr':'40003', 'blockname':'holdingreg',
                                    'blocktype':3},
                                'dnp3': {} }
            } ],
